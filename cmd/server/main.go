...
import (
	...
	"github.com/router-for-me/CLIProxyAPI/v6/internal/translator_new"
...
func main() {
	...
	sdktranslator.EnableCanonicalTranslator(cfg.UseCanonicalTranslator)
	sdktranslator.SetCanonicalAdapter(&translator_new.Adapter{Cfg: cfg})
